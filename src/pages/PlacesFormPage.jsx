    ...
    async function savePlace(ev) {
        ...
        if (id) {
            ...
            await axios.put('/places', {
                id, ...placeData,token: localStorage.getItem('jwttoken')
            ...
            //new Place
            const newData = { ...placeData, token: localStorage.getItem('jwttoken') }
            await axios.post('/places', newData, { withCredentials: true });
            alert("Place added");
            setRedirect(true);
        }
    }
